public class BlackjackPlayerUnitTest{
    ...
    public static void main(String[] args) {
        Player p1 = new BlackjackPlayer("Player 1", 0, 0);
        Player p2 = new BlackjackPlayer("Player 2", 0, 0);
        Player p3 = new BlackjackPlayer("Player 3", 0, 0);
        Player p4 = new BlackjackPlayer("Player 4", 0, 0);
        Player p5 = new BlackjackPlayer("Player 5", 0, 0);
        Player p6 = new BlackjackPlayer("Player 6", 0, 0);
        Player p7 = new BlackjackPlayer("Player 7", 0, 0);
        Player p8 = new BlackjackPlayer("Player 8", 0, 0);
        Player p9 = new BlackjackPlayer("Player 9", 0, 0);
