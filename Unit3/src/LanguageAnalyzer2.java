...
public class LanguageAnalyzer2 {
   static String [] wordArray;
    ...
    public static String[] toWordArray(String str){
        ...
        arr[index] = str.substring(wordStart);
        return arr;
    }
    /**
    ...
    public static double calcReadingDifficulty(String str) {
        ...
        double formula = (CONSTANT1 - CONSTANT2 *
                (totalWords / totalSentences)) - (CONSTANT3
                        * (totalSyllables /
                                totalWords));
